# Public information added on 2026-09-17

These additions were checked against public university, society, and publisher records.
Published Japanese article titles are retained. English descriptions of Japanese talks,
organized sessions, outreach activities, and the course 領域情報学概論 are editorial
translations, not claims that these are the officially registered English titles.
...
- Retain the existing 2024 Machine Learning entry. Add 2026 separately; do not infer a 2025 appointment or continuous teaching period.
- Translate 副担当 as “Contributing Instructor,” not “Teaching Assistant.” Retain the Japanese course name alongside its English rendering.
- Use the society's published author order for the 2025 OS-14 report (Yamada before Imai); the university database lists these two authors in the opposite order.
- Classify the three new articles under Other Publications, separate from the existing research papers. The report links point to the society's issue contents, which identify the individual reports, rather than presenting the DOI of the entire collected session report as an individual article DOI.
- The publisher calls the Haikan Gijutsu issue “April 2025”; the university bibliography gives volume 67, issue 5, pages 20–24. The issue number is not used as a calendar month.
- Keep the original Japanese titles of the new articles and English bibliographic descriptions. Media coverage is an English summary rather than a purported verbatim English newspaper headline.
